...
<div class="page-slider margin-bottom-35">
	...
	<div id="layerslider"
		...
		<div class="ls-slide ls-slide1"
			...
			<img
				src="<c:url value="/templates/assets/frontend/pages/img/layerslider/slide1/theme1.jpg" />"
		...
		<div class="ls-slide ls-slide2"
			...
			<img src="../../assets/frontend/pages/img/layerslider/slide2/bg.jpg"
				class="ls-bg" alt="Slide background">
		...
		<div class="ls-slide ls-slide3"
			...
			<img src="../../assets/frontend/pages/img/layerslider/slide3/bg.jpg"
				class="ls-bg" alt="Slide background">
		...
		<div class="ls-slide ls-slide4"
			...
			<img src="../../assets/frontend/pages/img/layerslider/slide5/bg.jpg"
				class="ls-bg" alt="Slide background">
		...
		<div class="row margin-bottom-40">
			...
			<div class="col-md-12 sale-product">
				...
				<div class="owl-carousel owl-carousel5">
					<c:forEach items="${list5NewProduct}" var="o">
						<div>
				...
				<ul class="list-group margin-bottom-25 sidebar-menu">
					<c:forEach items="${listAllCategory}" var="o">
						<li class="list-group-item clearfix ${tagactive==o.cate_id ? "active":""}"><a
							href="product?cid=${o.cate_id}"><img src="${o.icons}" width="35" height="35"><i class="fa fa-angle"></i>
								${o.cname}</a></li>
					</c:forEach>
				</ul>
			</div>
		...
		<div class="row margin-bottom-35 ">
			...
			<div class="col-md-6 two-items-bottom-items">
				...
				<div class="owl-carousel owl-carousel2">
					<c:forEach items="${listFirst2Product}" var="o">
						<div>
							<div class="product-item">
								<div class="pi-img-wrapper">
									<img src="${o.image}" class="img-responsive"
					...
					<div id="myCarousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<img
									src="../../assets/frontend/pages/img/index-sliders/slide1.jpg"
									class="img-responsive" alt="Berry Lace Dress">
							</div>
							<div class="item">
								<img
									src="../../assets/frontend/pages/img/index-sliders/slide2.jpg"
									class="img-responsive" alt="Berry Lace Dress">
							</div>
							<div class="item">
								<img
									src="../../assets/frontend/pages/img/index-sliders/slide3.jpg"
									class="img-responsive" alt="Berry Lace Dress">
							</div>
						</div>
					</div>
