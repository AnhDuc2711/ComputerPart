			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu "
					...
					<li><a href="javascript:;"> <i class="icon-basket"></i> <span
						...
						<ul class="sub-menu">
							<li><a href="/KDA/admin/category/add"> <i
									class="icon-basket"></i> Thêm Danh Mục
							</a></li>
							<li><a href="/KDA/admin/category/list"> <i
									class="icon-tag"></i> Danh Sách Danh Mục
							</a></li>
						</ul></li>
					<li><a href="javascript:;"> <i class="icon-rocket"></i> <span
						...
						<ul class="sub-menu">
							<li><a href="/KDA/admin/product/add"> <i class="icon-basket"></i>
									Thêm Sản Phẩm
							</a></li>
							...
							<a href="/KDA/admin/product/my-product?${sessionScope.acc.uid }"> <i
									class="icon-basket"></i> My Product
							</a></li>
						</ul></li>
					<li><a href="javascript:;"> <i class="icon-diamond"></i> <span
						...
						<ul class="sub-menu">
							<li><a href="ecommerce_orders.html"> <i
									class="icon-basket"></i> Thêm Tài Khoản
							</a></li>
							<li><a href="/KDA/admin/user/list"> <i
									class="icon-basket"></i> Danh Sách Tài Khoản
							</a></li>
						</ul></li>
