		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6">
				<ul class="list-unstyled list-inline pull-right">
					<li><img
						src="<c:url value="/templates/assets/frontend/layout/img/payments/MasterCard.jpg" />"
						alt="We accept MasterCard" title="We accept MasterCard"></li>
					<li><img
						src="<c:url value="/templates/assets/frontend/layout/img/payments/PayPal.jpg" />"
						alt="We accept PayPal" title="We accept PayPal"></li>
					<li><img
						src="<c:url value="/templates/assets/frontend/layout/img/payments/visa.jpg" />"
